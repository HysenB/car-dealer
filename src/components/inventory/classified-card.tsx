...
function formatTransmission(transimission: Transmission) {
    return transimission === Transmission.AUTOMATIC ? "Automatic" : "Manual";
}
...
const getKeyClassifiedInfo = (classified: ClassifiedWithImages) => {
    return [
        ...
        },
        {
            ...
            value: classified?.transimission
                ? formatTransmission(classified?.transimission)
                : null,
        },
        {
            id: "fuelType",
        ...
        <div className="bg-white relative rounded-md shadow-md overflow-hidden flex flex-col">
            ...
            <div className="p-4 flex flex-col space-y-3">
                <Link
                    ...
                    className="text-sm md:text-base lg:text-lg font-semibold line-clamp-1 transition-colors"
                >
                    {classified.title}
                </Link>
            ...
            <div className="mt-4 flex flex-col lg:flex-row space-y-2 lg:space-y-0 lg:gap-x-2 w-full">
                ...
                <Button
                    className="flex-1 py-2 lg:py-2.5 h-full text-xs md:tex-sm xl:text-base"
                    asChild
                    size="sm"
                >
